		...
		<div class="div_any">
			<div class="left div_any01">
				<div class="div_any_child">
					<div class="div_any_title"><img src="../../assets/image/title_1.png">变化类型统计 </div>
					<div id="chartPie" class="p_chart"></div>
				</div>
				<div class="div_any_child">
					<div class="div_any_title"><img src="../../assets/image/title_4.png">变化状态统计 </div>
					<div id="chartColumn" class="p_chart"></div>
				</div>
				<div class="div_any_child">
					<div class="div_any_title"><img src="../../assets/image/title_2.png">问题描述</div>
			...
			<div class="div_any02 left ">
				<div class="div_any_child div_height">
					<div class="div_any_title any_title_width"><img src="../../assets/image/title_3.png">变化信息 </div>
					<div id="map_div">
						<div id="viewer2">
	...
	export default {
		...
		mounted: function() {
			...
			shpData1.features.forEach(function(v) {
				...
				var hierarchys = new Cesium.PolygonHierarchy(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[
					0].toString() + "]")));

				if (v.geometry.rings.length > 1) {
					hierarchys = new Cesium.PolygonHierarchy(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[
							0].toString() + "]")),
						[new Cesium.PolygonHierarchy(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[1].toString() +
							"]")))]);
				}
				...
				var fentitie = new Cesium.Entity({
					...
					polyline: {
						positions: Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings.toString() + "]")),
						width: 2,
						material: Cesium.Color.TRANSPARENT,
						...
						function(canvas) {
							return viewer.entities.add({
								...
								billboard: {
									image: canvas.toDataURL(),
									verticalOrigin: Cesium.VerticalOrigin.BOTTOM,
									distanceDisplayCondition: new Cesium.DistanceDisplayCondition(0, 90000), //可视范围
									disableDepthTestDistance: Number.POSITIVE_INFINITY //广告牌的文字不进行深度检测
								},
							});
						}
			...
			var infoDiv = '<div id="trackPopUp4" style="display:none;" >' +
			...
			handler.setInputAction(function(event) {
					...
					if (pick && pick.id) {
						...
						var content =
							'<tr><th style="color:white;">TB_ID:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.TB_ID +
							'></td></tr>' +
							'<tr><th style="color:white;">PRE_ID:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.PRE_ID +
							'></td></tr>' +
							'<tr><th style="color:white;">POST_ID:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.POST_ID +
							'></td></tr>' +
							'<tr><th style="color:white;">类型:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.LX +
							'></td></tr>' +
							'<tr><th style="color:white;">等级:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.Level +
							'></td></tr>' +
							'<tr><th style="color:white;">变化类型:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.BHLX +
							'></td></tr>' +
							'<tr><th style="color:white;">变化面积:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.Area +
							'></td></tr>' +
							'<tr><th style="color:white;">变化体积:</th><td><input class="dtInput1" " value=' + pick.id._properties
							.Volume +
							'></td></tr>'
						var obj = {
		...
		methods: {
			drawColumnChart() {
				...
				this.chartColumn.setOption({
							...
							dataset: {
								source: [
									['product', '大型建筑工地', '疑似货运源头', '疑似开采点', '沙石囤积点'],
									['面积变化', 11, 1, 18, 18],
									['新增', 4, 1, 1, 2],
									['减少', 1, 0, 0, 3]
								]
